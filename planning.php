    ...
    <div class="planning">
              ...
              <div class="events1">
                <div class="card1">
                  ...
                  <div class="event-details1">
                    ...
                    <div class="second-event-details">Jan, Amsterdam</div>
                  </div>
                </div>
                <div class="card1">
                  ...
                  <div class="event-details1">
                    ...
                    <div class="text14">Online</div>
                    <div class="second-event-details">Lisa, Utrecht</div>
                  </div>
                </div>
                <div class="card1">
                  ...
                  <div class="event-details1">
                    ...
                    <div class="text14">Online</div>
                    <div class="second-event-details">Mark, Rotterdam</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="events1">
                <div class="card1">
                  ...
                  <div class="event-details1">
                    ...
                    <div class="second-event-details">Sophie, Den Haag</div>
                  </div>
                </div>
                <div class="card1">
                  <div class="iconactionvisibilitypx">9:00 uur</div>
      ...
      <footer class="footer-74">
        <div class="content44">
          ...
          <div class="links4">
            <a href="./about.html" class="text13">Over ons</a>
...
<body>
    <div class="planning">
        <header class="inloggen1">
            <!-- Jouw bestaande header code -->
        </header>

        <!-- Planning en schema sectie -->
        <main class="header-54-parent">
            <section class="header-541">
                <h1 class="short-heading-here3">Planning</h1>
                <div class="lorem-ipsum-dolor9">
            ...
            <section class="event-31">
                ...
                <div class="content43">
                    ...
                    // Query om evenementen op te halen
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            // Nieuwe dag sectie starten
                            if ($event_date != $current_date) {
                                if ($current_date !== null) {
                                    echo '</div></div>'; // Sluit de vorige dag sectie af
                                }
                        ...
                        echo '</div></div>'; // Sluit de laatste dag sectie af
                    } else {
